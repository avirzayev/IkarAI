...
exec flock -n session/run.lock claude -p "Follow /opt/ideas/games/ikarAI/RUNBOOK.md for this cycle. If the session cookie is invalid or missing, stop, create a Human Required entry, and do not attempt to log in yourself." \
